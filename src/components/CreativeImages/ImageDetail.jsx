...
import { FaHeart, FaCopy, FaArrowLeft } from "react-icons/fa";

export default function ImageDetail({ image, onBack }) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-1 text-sm text-gray-400">
              <p>Shared by @{image.createdBy}</p>
              <p>Posted on {new Date(image.createdOn).toLocaleDateString('en-US', { 
                month: 'long', 
                day: 'numeric', 
                year: 'numeric' 
              })}</p>
            ...
            <div className="bg-gray-900 rounded-2xl p-6 space-y-2">
              ...
              <p className="text-white font-semibold">{image.model}</p>
            </div>
            ...
            <div className="bg-gray-900 rounded-2xl p-6 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                <div>
                  <p className="text-2xl font-bold text-cyan-400">{image.copiedCount}</p>
                  <p className="text-sm text-gray-400">Times Copied</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-purple-400">{image.type.toUpperCase()}</p>
