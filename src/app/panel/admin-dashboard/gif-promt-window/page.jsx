...
export default function GifPromptWindowPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Upload
      const response = await gifsAPI.uploadGIF(formData);
      
      if (response.success) {
        setSuccess("GIF uploaded successfully! It's now pending review.");
        // Reset form
        setProjectTitle("");
        setPrompt("");
        setTechnicalNotes("");
  ...
  return (
    <div className="min-h-screen bg-black text-white p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold mb-2">GIF Prompt Upload</h1>
        <p className="text-gray-400 mb-8">Upload your AI-generated GIF animations</p>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3">
                    GIF UPLOAD <span className="text-red-500">*</span>
                  </label>
                  <div className="border-2 border-dashed border-gray-700 rounded-xl p-12 text-center hover:border-cyan-600 transition-colors cursor-pointer relative">
                    ...
                    {previewUrl ? (
                      ...
                      <div className="flex flex-col items-center gap-4">
                        ...
                        <div>
                          <p className="text-gray-300 mb-1">Drag a GIF here or click to upload</p>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Runway, Pika Labs"
                    className="w-full bg-gray-950 border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-600"
                  />
                </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Paste the exact prompt you used to generate this GIF"
                    rows={6}
                    maxLength={2000}
